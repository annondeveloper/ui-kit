...
const pages: { path: string; label: string; icon: IconName }[] = [
  ...
  { path: '/ai-plugins', label: 'AI Plugins', icon: 'zap' },
...
const componentGroups: ComponentGroup[] = [
  {
    ...
    items: [
      ...
      { name: 'SegmentedControl', path: '/components/segmented-control' },
      { name: 'Chip', path: '/components/chip' },
      { name: 'ActionIcon', path: '/components/action-icon' },
      { name: 'CopyButton', path: '/components/copy-button' },
      { name: 'Indicator', path: '/components/indicator' },
      { name: 'BackToTop', path: '/components/back-to-top' },
    ],
  },
  {
    label: 'Forms',
    ...
    items: [
      ...
      { name: 'Calendar', path: '/components/calendar', premium: true },
      { name: 'DateRangePicker', path: '/components/date-range-picker', premium: true },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'NativeTooltip', path: '/components/native-tooltip' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'TableOfContents', path: '/components/table-of-contents' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'JsonViewer', path: '/components/json-viewer' },
      { name: 'CodeEditor', path: '/components/code-editor' },
      { name: 'RichTextEditor', path: '/components/rich-text-editor' },
      { name: 'Cropper', path: '/components/cropper' },
