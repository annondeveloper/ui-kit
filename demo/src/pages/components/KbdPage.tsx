...
import { Kbd as PremiumKbd } from '@ui/premium/kbd'
...
function PlaygroundSection({ tier: tierProp, brandColor }: { tier: Tier; brandColor: string }) {
  ...
  const KbdComponent = tier === 'lite' ? LiteKbd : tier === 'premium' ? PremiumKbd : Kbd
      ...
      <div className="kbd-page__playground">
        <div className="kbd-page__playground-preview">
          <div className="kbd-page__playground-result">
            <KbdComponent size={size} variant={variant} motion={motion}>{content}</KbdComponent>
          </div>
...
export default function KbdPage() {
  ...
  return (
    <div className="kbd-page" ref={pageRef} style={themeStyle}>
      {/* ── 1. Hero Header ──────────────────────────────── */}
      ...
      {/* ── Brand Color ──────────────────────────────────── */}
      <section className="kbd-page__section" id="brand-color">
        <h2 className="kbd-page__section-title">
          <a href="#brand-color">Brand Color</a>
        </h2>
        <p className="kbd-page__section-desc">
          Pick a brand color to see all keyboard indicators update in real-time. The theme generates
      ...
      {/* ── Source ──────────────────────────────────────── */}
      <section className="kbd-page__section" id="source">
