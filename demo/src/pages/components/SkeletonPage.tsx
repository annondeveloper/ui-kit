...
const skeletonProps: PropDef[] = [
  ...
  { name: 'lineHeight', type: 'string | number', description: 'Height of each individual line in multi-line mode.' },
  { name: 'lineGap', type: 'string | number', description: 'Gap between lines in multi-line mode.' },
