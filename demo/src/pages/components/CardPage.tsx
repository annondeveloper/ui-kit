...
const cardProps: PropDef[] = [
  ...
  { name: 'loading', type: 'boolean', default: 'false', description: 'When true, shows a Skeleton overlay over the card content.' },
  { name: 'bordered', type: 'boolean', description: 'Explicit border control independent of variant.' },
  { name: 'classNames', type: "Partial<Record<'root' | 'header' | 'footer' | 'content', string>>", description: 'Custom class names for internal parts (root, header, footer, content).' },
