      ...
      <RevealSection className="home-section">
        ...
        <div className="home-features-grid">
          {[
            ...
            { icon: 'copy' as IconName, title: 'Container Query Tokens', desc: 'useContainerSize() hook + responsive props. Components adapt to their container, not the viewport.', link: '/docs?tab=container-queries' },
            { icon: 'zap' as IconName, title: 'View Transitions', desc: 'useViewTransition() with 6 presets. Morphing route transitions, crossfade, slide, zoom — zero config.', link: '/docs?tab=view-transitions' },
            ...
            { icon: 'terminal' as IconName, title: 'CLI Scaffolding', desc: 'ui-kit add/create commands, 5 project templates, Figma token export, interactive mode.', link: '/docs?tab=cli' },
            { icon: 'download' as IconName, title: 'Figma Plugin', desc: 'Export design tokens as Figma Variables JSON, Style Dictionary format, component mapping.', link: '/figma' },
          ].map((f, i) => (
