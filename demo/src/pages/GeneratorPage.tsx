...
const styles = css`
  @layer demo {
    ...
    /* Lite tier: muted, no effects */
    .gen-preview__content[data-tier="lite"] {
      filter: saturate(0.6);
    }
    .gen-preview__content[data-tier="lite"]::after {
      content: 'Lite — no animations, minimal CSS';
      display: block;
    ...
    .gen-preview__content[data-tier="standard"]::after {
      content: 'Standard — full features, motion levels 0-3';
      display: block;
      margin-block-start: 1rem;
      padding: 0.5rem 0.75rem;
      background: var(--bg-hover);
    ...
    /* Premium tier: glow + shimmer */
    .gen-preview__content[data-tier="premium"] {
      box-shadow: 0 0 20px oklch(from var(--brand) l c h / 0.1),
                  inset 0 1px 0 oklch(from var(--brand) l c h / 0.08);
    }
    .gen-preview__content[data-tier="premium"]::after {
      content: 'Premium — aurora glow, spring physics, shimmer, particles';
      display: block;
      margin-block-start: 1rem;
      padding: 0.5rem 0.75rem;
    ...
    <div className="gen-page">
      ...
      <div className="gen-section">
        ...
        <div className="gen-preview">
          ...
          <div className="gen-preview__content" data-tier={activeTier}>
