...
- **ButtonGroup** — grouped button container with shared styling
- **CopyButton** — one-click copy to clipboard with feedback animation
- **ShimmerButton** — shimmering gradient border animation

#### Typography & Text
- **Highlight** — text highlighting with search match support
...
- **Spoiler** — collapsible content with show more/less toggle
...
- **Calendar** — standalone calendar display with date selection
...
- **Stepper** — step indicator with progress tracking
...
| CSS extractions | 144 component files |
