...
const DOMAIN_CATEGORY_MAP: Record<string, string> = {
  ...
  NetworkInterfaceGrid: 'infrastructure',
  VlanBusBar: 'infrastructure',
  TopologyGraph: 'data-visualization',
  PipelineDAG: 'data-visualization',
  DashboardTemplate: 'infrastructure',
  PluginDashboard: 'infrastructure',
...
const RELATED_GROUPS: string[][] = [
  ...
  ['RackDiagram', 'SwitchFaceplate', 'PortStatusGrid', 'NetworkInterfaceGrid'],
  ['NetworkInterfaceGrid', 'VlanBusBar', 'SwitchFaceplate'],
  ['TopologyGraph', 'PipelineDAG', 'GeoMap'],
  ['DashboardTemplate', 'DashboardGrid', 'PluginDashboard', 'UpstreamDashboard'],
  ['PipelineDAG', 'PipelineStage', 'TopologyGraph'],
